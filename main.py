...
losses = {
    ...
    "normalized-log-softmax": NormalizedLogSoftmaxLoss,
    "log-normalized-softmax": LogNormalizedSoftmaxLoss
}
...
class MultiLabelTextProcessor(DataProcessor):
    ...
    # get the inverse normed frequencies of the training set
...
def main():
    ...
    parser.add_argument("--loss", default=None, type=str, required=True,
                        help="The loss option selected in the list: " + ", ".join(losses.keys()))
    parser.add_argument("--exp_name", default=None, type=str, required=True,
                        help="Name of the experiment to save the evaluated predictions.")
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        model_directory = args.model_name_or_path if args.zero_shot else args.output_dir
        
        tokenizer = tokenizer_class.from_pretrained(model_directory, do_lower_case=args.do_lower_case) 
        ...
        for checkpoint in checkpoints:
            ...
            # write the predictions array (num_samples) x (num_frames) into pickle file
            filename = os.path.join(args.output_dir, "predictions.pkl")
